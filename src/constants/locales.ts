...
export const translations = {
  bn: {
    header: {
      home: "হোম",
      vehicles: "অটো রিকশা",
      batteries: "পানি ব্যাটারি",
      parts: "স্পেয়ার পার্টস",
      contact: "যোগাযোগ",
      phone: "০১৭৪৫৬০৭৫৫৯",
    },
    footer: {
      desc: "প্রিমিয়াম ইলেকট্রিক অটো-রিকশা, উন্নত পানি ব্যাটারি এবং আসল খুচরা যন্ত্রাংশের মাধ্যমে যাতায়াত ব্যবস্থায় পরিবেশ বান্ধব বিপ্লবের নেতৃত্ব দিচ্ছি।",
      titleQuick: "কুইক লিঙ্ক",
      titleProducts: "আমাদের প্রোডাক্টস",
      titleContact: "যোগাযোগ",
      navHome: "হোম",
      navAbout: "আমাদের সম্পর্কে",
      navFleet: "আমাদের রিকশা",
      navContact: "যোগাযোগ করুন",
      prodRickshaw: "ইলেকট্রিক অটো রিকশা",
      prodBattery: "পানি ব্যাটারি প্যাক",
      prodParts: "আসল স্পেয়ার পার্টস",
      prodSupport: "সার্ভিস ও সাপোর্ট",
      address:
        "কাজীয়া কান্দা (ইন্দিরা পার), ইভা ব্যাটারি অ্যান্ড অটোস, হালুয়াঘাট রোড, ফুলপুর, ময়মনসিংহ, ঢাকা, বাংলাদেশ",
      rights: "সর্বস্বত্ব সংরক্ষিত।",
      privacy: "প্রাইভেসি পলিসি",
      terms: "শর্তাবলী",
    },
    hero: {
      reviews: "৪.৯ (৫ হাজার+ বিশ্বস্ত রিভিউ)",
      btnOrder: "যোগাযোগ করুন", // অথবা "যোগাযোগ করুন"
      btnExplore: "আরও জানুন",
      pathOrder: "/bn/contact", // 🎯 বাংলা কন্টাক্ট পেজের পাথ
      pathExplore: "#featured-products", // 🎯 ফিচার্ড প্রোডাক্টস সেকশনের আইডি
      slides: [
        {
          id: 1,
          title: "প্রিমিয়াম ইলেকট্রিক অটো রিকশা",
          subtitle:
            "উচ্চ স্থায়িত্ব এবং সর্বোচ্চ আরাম সহ পরিবেশ বান্ধব যাতায়াতের ভবিষ্যৎ অভিজ্ঞতা নিন।",
          image: "/a1.png",
          bgColor: "bg-[#1e293b]",
          waveColor: "#334155",
        ...
        {
          id: 2,
          title: "উচ্চ কার্যক্ষমতার পানি ব্যাটারি",
          subtitle:
            "দীর্ঘস্থায়ী শক্তি। দীর্ঘ জীবন এবং দ্রুত চার্জিং ক্ষমতার জন্য তৈরি হেভি-ডিউটি ব্যাটারি।",
          image: "/b-1.png",
          bgColor: "bg-[#064e3b]",
          waveColor: "#047857",
        ...
        {
          id: 3,
          title: "আসল রিকশার স্পেয়ার পার্টস",
          subtitle:
            "কোনো রকম বাধা ছাড়াই আপনার গাড়ি সচল রাখতে টপ-গ্রেড এবং টেকসই খুচরা যন্ত্রাংশ।",
          image: "/p1.png",
          bgColor: "bg-[#7c2d12]",
          waveColor: "#9a3412",
    ...
    battery: {
      badge: "উন্নত পানি ব্যাটারি",
      title: "ইজিবাইকের জন্য শক্তিশালী চায়না পানি ব্যাটারি বিপ্লব",
      desc: "ইভা ব্যাটারি অ্যান্ড অটোস নিয়ে এলো দীর্ঘস্থায়ী এবং উচ্চ কার্যক্ষমতাসম্পন্ন চায়না লিড-অ্যাসিড (পানি) ব্যাটারি। আমাদের ব্যাটারিগুলো বিশেষভাবে বাংলাদেশের রাস্তা ও আবহাওয়ার কথা মাথায় রেখে তৈরি, যা দেয় সর্বোচ্চ মাইলেজ ও দীর্ঘস্থায়িত্বের নিশ্চয়তা।",
      card1Title: "দ্রুত চার্জিং প্রযুক্তি",
      card1Desc:
        "অল্প সময়ে পূর্ণ চার্জ নেওয়ার ক্ষমতা এবং উন্নত চার্জ ধরে রাখার ব্যাকআপ সুবিধা।",
      card2Title: "দীর্ঘ স্থায়িত্ব ও লাইফ",
      card2Desc:
        "উচ্চ ক্ষমতাসম্পন্ন হেভি-ডিউটি প্লেট, যা সাধারণ ব্যাটারির চেয়ে বেশিদিন সার্ভিস দেয়।",
      card3Title: "সর্বোচ্চ মাইলেজ ও শক্তি",
      card3Desc:
        "একবার ফুল চার্জে গাড়ি চলবে দীর্ঘ পথ, চালকদের প্রতিদিনের আয় বাড়বে দ্বিগুণ।",
      card4Title: "নিরাপত্তা ও গ্যারান্টি",
      card4Desc:
  ...
  en: {
    ...
    footer: {
      desc: "Leading the green revolution in transportation with top-grade electric auto-rickshaws, premium Lead-acid batteries, and authentic spare parts.",
      titleQuick: "Quick Links",
      titleProducts: "Our Products",
      titleContact: "Contact Info",
      navHome: "Home",
      navAbout: "About Us",
      navFleet: "Our Fleet",
      navContact: "Contact Us",
      prodRickshaw: "Electric Auto Rickshaws",
      prodBattery: "Lead-acid Battery Packs",
      prodParts: "Genuine Spare Parts",
      prodSupport: "Maintenance & Support",
      address:
        "Kazia Kanda(indirapar), Eva Battery & Autos, haluaghat Road, phulpur, Mymensingh, Dhaka, Bangladesh",
      rights: "All Rights Reserved.",
      privacy: "Privacy Policy",
      terms: "Terms of Service",
    },
    hero: {
      reviews: "4.9 (5k+ Trusted Reviews)",
      btnOrder: "CONTACT NOW",
      btnExplore: "EXPLORE MORE",
      pathOrder: "/en/contact", // 🎯 ইংলিশ কন্টাক্ট পেজের পাথ
      pathExplore: "#featured-products", // 🎯 ফিচার্ড প্রোডাক্টস সেকশনের আইডি
      slides: [
        {
          id: 1,
    ...
    battery: {
      ...
      title: "The China Lead-acid Revolution For Easy Bikes",
      desc: "Upgrade your electric vehicles with our factory-imported high-efficiency Lead-acid packs that increase daily mileage and boost your income.",
      card1Title: "3X Faster Charging",
      card1Desc: "Full juice in under 3 hours instead of overnight charging.",
      card2Title: "Double Daily Income",
      card2Desc:
        "High mileage per charge guarantees extra daily passenger trips.",
      card3Title: "Smart Protection System",
      card3Desc:
        "Automated protection systems preventing over-voltage or overheating.",
      card4Title: "Replacement Warranty",
      card4Desc:
        "Official written factory replacement guarantee for absolute peace of mind.",
    },
    partnership: {
