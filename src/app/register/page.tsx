  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center p-4">
      ...
      <motion.div
        ...
        className="w-full max-w-4xl grid md:grid-cols-2 rounded-2xl overflow-hidden backdrop-blur-sm bg-white/10"
      >
        {/* Welcome Section */}
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              <div className="space-y-2">
                ...
                <input
                  ...
                  className="w-full px-4 py-2 bg-white/10 border border-white/20 rounded-md
                           ...
                           focus:outline-hidden focus:border-white/40"
                  placeholder="Name"
                />
                {errors.name && (
              ...
              <button
                ...
                className="w-full py-2 px-4 bg-[#c48200] text-white rounded-md
                          transition-colors
                         focus:outline-hidden focus:bg-none focus:none focus:ring-offset-2"
              >
